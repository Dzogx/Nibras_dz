...
const INTEGRATIVE_STRATEGIES = [
  {
    ...
    strategy: {
      ...
      name: "البازل التعاوني (Jigsaw) على مكونات الوضعيات الإدماجية",
      rationale: "وضعية الإدماج مركّبة: تتطلب سَندات (خريطة/نص/جدول) + منهجية + موارد من مقاطع مختلفة. استراتيجية البازل (Aronson, 1971) توزّع المكونات على مجموعات «خبراء» تتقن كلًّ منها جزءًا ثم تعيد تركيبه جماعيًا — فتمسك التلاميذ كل أداة على حدة قبل دمجها في حلّ كامل، وهو نمط الإدماج المطلوب في الاختبار الفصلي.",
      totalMinutes: 55,
      phases: [
        { stage: "تقسيم المكونات وتوزيع الأدوار", minutes: 5, teacherRole: "يقسّم الوضعية الإدماجية إلى 3-4 مكونات (سند أول/سند ثانٍ/المنهجية/الموارد المستدعاة) ويشكل أفواجًا أصلية من 3-4 تلاميذ", studentRole: "يختار كل تلميذ مكونًا واحدًا ليصبح «خبير» فيه ويغادر فوجه نحو فريق الخبراء", tips: "المكونات توازي شبكة التقويم: وثائق، منهجية، موارد — كي تُدرك قيمة كل مكون في تقدير النتيجة" },
        { stage: "عمل فريق الخبراء", minutes: 12, teacherRole: "يمنح كل فريق خبير نفس مكونه مع ورقة عمل موجهة ويدير الزمن ويصوّب الأخطاء الشائعة", studentRole: "يتقن الخبراء مكونهم: يستخرجون كل ما يمكن استخراجه من السند أو المنهجية ويبنيون خطوات الحل", tips: "الخبير لا يحل الوضعية كاملة — يتقن قطعة واحدة فقط ويتعلم تعليمها لزملائه" },
        { stage: "العودة للأفواج الأصلية والتعليم المتبادل", minutes: 12, teacherRole: "يعيد الخبراء إلى أفواجهم الأصلية ويدير جولة التعليم: كل خبير يشرح مكونه ويُصغي للآخرين", studentRole: "يشرح كل خبير مكونه لزملائه ويجمع الأفواج المعلومات في ورقة تجميع موحدة", tips: "شرح الزميل يرسّخ مرتين: عند الشرح وعند الاستماع — هذا جوهر التعلم التعاوني" },
        { stage: "التركيب الجماعي للحل", minutes: 13, teacherRole: "يقود المرحلة الانتقالية من التجميع إلى التركيب: كيف تُدمج المكونات في حل مهيكل وفق المنهجية؟", studentRole: "يحرر الفوج حلًّا كاملًا موحدًا (ملاءمة، تحليل السندات، المنهجية، الإتقان)", tips: "الملاءمة (فهم التعليمة) تُتفق عليها أولًا — فحل سؤال خاطئ مهما صُحّت خطواته لا يُتقن" },
        { stage: "المواجهة بالنموذج والمعايرة", minutes: 10, teacherRole: "يعرض حلًّا نموذجيًا جزئيًا ويصحح عينات من الأفواج بشبكة التقويم الرسمية", studentRole: "يقارن حلّ فوجه بالنموذج ويقدّر نفسه بالشبكة ويحدد مكونه الأضعف", tips: "الشبكة الرسمية (الملاءمة/أدوات المادة/المنهجية/الإتقان) هي ذاتها المعتمدة في التقويم التحصيلي" },
        { stage: "الختام والتقويم الذاتي", minutes: 3, teacherRole: "يحدد مؤشر النضج الجماعي لكل مكون ويرشد للتدرّب العلاجي", studentRole: "يحدد مكونه الشخصي الناقص ويختار تمرينًا فرديًا علاجيًا", tips: "البازل يكشف الثغرات الشخصية بدقة: كل خبير يعرف ما أتقنه وما لم يتقنه" },
      ],
      generalTips: [
        "جسّد مكونات الوضعية في بطاقات مادية (سند/منهجية/موارد) — التوزيع اليدوي يجعل البازل ملموسًا",
        "نوّع تكوين الأفواج كل وضعية إدماجية كي لا يظل «الخبير القوي» وحده يحمل فوجه",
        "البازل مثالي للوضعية الإدماجية الجزئية (وضعية إدماجية مصغرة) في منتصف المقطع ومنتصف الفصل",
        "وثّق ورقة التجميع النهائية في المكتبة كنموذج لإعادة الاستعمال في حصص العلاج",
      ],
    },
  },
  {
...
export function buildLLMPrompt(ctx: CompetencySectionContext): string {
  ...
  return [
    `أنت مهندس بيداغوجي خبير في منهاج الدراسات الاجتماعية للتعليم المتوسط الجزائري وفي بيداغوجيات التعلم النشط (التحقيق التاريخي، الاستكشاف الجغرافي، الحوار السقراطي، حل الوضعية الإدماجية، البازل التعاوني Jigsaw).`,
    ...
    `3. بنية الحصة: افتتاح/استرجاع (5-8 د) ثم نشاط بنيوي مركزي من بيداغوجيات التعلم النشط يتدرج من المورد إلى الاستنتاج (25-35 د) — يمكن اعتماد بيداغوجية البازل التعاوني (Jigsaw) عند تعدد مكونات الوضعية (سندات/منهجية/موارد) بتوزيعها على أفواج خبراء ثم إعادة التركيب الجماعي — ثم تثبيت وترسيخ (8-12 د) ثم استثمار بسؤال من مستوى بلوم مرتفع (5-10 د) ثم ختام وتقويم ذاتي (3-5 د).`,
