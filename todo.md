...
- [ ] رصد الفجوات العملية (UX، نصوص غير تربوية، خطوات متكررة، مشاكل هاتف) وإصلاحها مباشرة
- [ ] تنظيف البيانات التجريبية من قاعدة البيانات قبل التسليم إن لم تعد مطلوبة (البيانات المرجعية تبقى)
- [ ] اختبارات انحدار وفحص TypeScript وCheckpoint
