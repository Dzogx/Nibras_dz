...
- [ ] إعادة تمثيل يوم عمل كامل عبر الواجهة (اليوم ← تجهيز مذكرة ← استراتيجية ← تسجيل حصة ← تقويم ← دفتر تنقيط ← كشف فصلي) وتدوين الملاحظات بموضوعية
- [ ] كتابة تقرير التجربة: ما يعمل بسلاسة / ما متعثر / أولويات التحسين وتسليمه
...
- [ ] رسالة سبب التعطيل تحت زر «توليد التقييم» عند عدم ملء العنوان
