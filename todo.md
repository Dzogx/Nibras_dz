...
- [ ] بحث شامل في مواقع ومستودعات GitHub للتعليم الجزائري والتعلم النشط والبيداغوجيات الحديثة، مع تحليل استفادة نبراس منها
...
- [ ] اختبارات انحدار كاملة وفحص TypeScript وCheckpoint نهائي + تنظيف ملاحظات المحاكاة قبل التسليم
...
- [ ] تشخيص: لماذا صفحة اليوم تعرض «تهيئة الموسم» عند المستخدم رغم وجود بيانات (1م1/2026-2027) في DB
- [ ] إصلاح السبب الجذري
- [ ] التحقق البصري + اختبارات + checkpoint
