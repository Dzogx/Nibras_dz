...
- [ ] تحديد منطق بصري يجعل كلمة «نبراس» الأصل الهندسي للشعار والرمز المستقل
- [ ] إعداد بدائل لشعار لفظي عربي متجهي سليم ورمز مشتق من الكلمة كاملة
- [ ] اختبار البدائل بصرياً على المقاسات والخلفيات الأساسية قبل الاعتماد

## قرار العلامة اللفظية الموحدة (18 أوت)

- [ ] بناء كلمة «نبراس» كعلامة عربية مخصصة تكون هي الشعار والأيقونة دون رمز منفصل
- [ ] اختبار اختزال الكلمة في favicon وأيقونة التطبيق مع الحفاظ على قابلية التعرّف

## امتداد بصري من الكلمة (18 أوت)

- [ ] تحليل مرجع الامتداد الضوئي وتثبيت قواعد تمنع تحوله إلى مصباح أو رمز مستقل
- [ ] رسم كلمة «نبراس» كعلامة لفظية مخصصة ذات مسار ضوء مندمج في بنيتها
- [ ] اشتقاق أيقونة ثانوية من المسار والكلمة مع إبقاء الشعار اللفظي هو الأصل

## الخط العربي المخصص لكلمة نبراس (18 أوت)

- [ ] تحديد خصائص الخط المرجعي المناسبة لكلمة «نبراس» دون نسخ تصميم مرجعي
- [ ] رسم ثلاثة بدائل عربية متجهية تركز على الكلمة قبل أي رمز أو امتداد بصري
- [ ] اختبار وضوح الخط المخصص في الشعار والنسخة المصغرة قبل الاعتماد

## إعادة الاستكشاف بعد رفض الاتجاه البنائي (18 أوت)

- [ ] توثيق أسباب رفض النسخة البنائية واستبعاد إعادة استخدامها أو تجميلها سطحياً
- [ ] ابتكار بدائل خطية جذرية لكلمة «نبراس» ذات شخصية خاصة لا تبدو خطاً كوفياً جاهزاً
- [ ] مراجعة بدائل جديدة مع المستخدم قبل بناء أي حزمة نهائية

## تطوير الاتجاه التحريري المتباين (18 أوت)

- [ ] إعادة رسم كلمة «نبراس» كتوقيع عربي مخصص انطلاقاً من الاتجاه التحريري دون استعمال خط جاهز كشعار نهائي
- [ ] اختبار نسب الحروف والنقط والاتصالات في النسخ الفاتحة والداكنة والمقاسات الصغيرة

## تصحيح الاتجاه بعد اختبار التوقيع التحريري (18 أوت)

- [ ] استبعاد الحروف المفككة والطابع التقليدي للتوقيع التحريري بعد المراجعة البصرية
- [ ] بناء كلمة «نبراس» هندسية عريضة ذات اتصال واضح وشخصية مخصصة غير كوفية جاهزة
- [ ] مقارنة الدراسة الهندسية بالمراجع التي فضّلها المستخدم قبل متابعة أي حزمة هوية

## الاتجاه المخصص: النور الصاعد فوق النون (19 أوت)

- [ ] بناء كلمة «نبراس» عريضة متصلة مع قوس نور صاعد مخصص من نقطة النون — مسارات SVG فقط بدون نصوص عربية
- [ ] ضبط القوس الصاعد هندسياً (نقطة البداية والنهاية والارتفاع) فوق نقطة النون دون الاصطدام بجسم الحرف
- [ ] تثبيت تموضع الكلمة داخل بطاقات لوحة المعاينة على الخلفيتين الفاتحة والداكنة
- [ ] اختبار النسخة المخصصة على المقاسات المصغرة (24/40/64px) والتباينات الفاتح والداكن
- [ ] عرض لوحة الدراسة المخصصة على الأستاذ للمراجعة قبل أي تطوير إضافي

## الشعار الثنائي NIBRAS | نبراس وفق مرجع الأستاذ (19 أوت)

- [ ] بناء الشعار: NIBRAS باللاتينية + فاصل رأسي + نبراس بالعربية كمسارات SVG + خط سفلي طويل
- [ ] مطابقة النسب والتباين مع المرجع المرفق IMG_20260819_020536.jpg دون نسخ تصميمه
- [ ] تجميع لوحة المعاينة والخلفيتين الفاتحة والداكنة واختبار المقاسات المصغرة
- [ ] عرض النسخة الثنائية على الأستاذ للمراجعة قبل اعتماد أي حزمة هوية

## الشعار اللاتكي (طلب جديد)
- [ ] إعادة بناء الشعار الثنائي NIBRAS | نبراس عبر قالب LaTeX XeLaTeX بنفس خطوط وثائق المنصة (Amiri/Noto Arabic)
- [ ] ضبط المحاذاة على خط استقامة واحد بين الكتابتين مع الفاصل الرأسي
- [ ] مراجعة الناتج بصريًا على الخلفيتين الفاتحة والداكنة
- [ ] عرض الشعار اللاتكي على الأستاذ للمراجعة
...
- [ ] إزالة كل إشارة لعلامة نبراس من قالب تقويم LaTeX: الشعار المزدوج في ترويسة الصفحة (fancyhead)، وترويسة وتذييل الوثيقة، ورابط رمز QR الخاص بالتحقق
- [ ] استبدال الشعار في الترويسة بترويسة رسمية للتوثيقة تُترك لمؤسسة الأستاذ أو بياناتها دون علامة تجارية
- [ ] إبقاء رمز التحقق QR في التذييل أو إزالة ارتباطه بعلامة نبراس إن لزم
- [ ] التحقق البصري من عينة PDF تقويم بدون أي اسم نبراس
- [ ] عدم انحدار: جميع الاختبارات وTypeScript
