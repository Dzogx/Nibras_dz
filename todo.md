...
- [ ] إضافة مواصفات السندات المولّدة إلى محرك القواعد الوطني (DOCUMENT_GENERATION_SPEC: جداول إحصائية ببيانات صحيحة، نصوص دستورية/قانونية رسمية، أوصاف خرائط معطيات جغرافية) لكل مادة مع قواعد العدد (1-2 لـ1-3AM، 2-3 لـ4AM/BEM، 1-2 لمدنية)
- [ ] تعليمات generateExam تُلزم السندات الوظيفية المرتبطة بالتعليمة في الوضعيات الإدماجية، برقم وعنوان لكل سند، مع حظر السندات الزائدة
- [ ] دفتر متابعة: سجل تنفيذ الوضعيات بتواريخها الفعلية + تقدم كل مقطع (منجز/إجمالي) + نسبة إنجاز المخطط السنوي + مؤشّر متقدم/متأخر/منتظم مقارنة بالرزنامة
- [ ] عرض لوحة التقدم على الرزنامة في Dashboard/Teacher OS (بطاقات المقاطع مع النسب)
...
- [ ] اختبارات سلامة + تشغيل كامل + checkpoint + مزامنة GitHub
