...
- [ ] حصر كل قراءات choices غير المحمية في إجراءات الذكاء الاصطناعي (بطاقات/تقويم/تقارير)
- [ ] حماية مولّد البطاقات من الاستجابة الناقصة مع رسالة عربية واضحة
- [ ] حماية مولّد التقويم والتقارير من الاستجابة الناقصة مع رسالة عربية واضحة
- [ ] إضافة اختبارات انحدار لمسار البطاقات والمسار الآخر على الأقل
- [ ] تشغيل كامل الاختبارات وفحص TypeScript وحفظ نقطة تفتيش
...
- [ ] توليد اختبار تجريبي عبر مسار التوليد الفعلي (الذكاء الاصطناعي) مع بنية 12+8 وأفعال بلوم
- [ ] التحقق من مطابقة الناتج للقواعد (النقاط، الأفعال، السندات، التعليمة، شبكة التقويم)
- [ ] تسليم الوثيقة النهائية بصيغة عربية RTL
...
- [ ] استكشاف صفحات DzExams للمستويات 1AM–4AM وBEM (تاريخ/جغرافيا وتربية مدنية) وتوثيق بنية المكتبة
- [ ] تحليل عينات التقويمات: أنواعها حسب الفصول، أنماط الأسئلة، السندات، توزيع النقاط، مستويات بلوم
- [ ] تقرير تحليلي مميز: موجود في DzExams مقابل مستنتج تصميمياً
- [ ] تحسين Assessment Studio بالأنماط المتكررة (إثراء سياق التوليد وأنماط الأسئلة)
- [ ] تحسين Inspector بأنماط التقويم الفعلية المعتمدة
- [ ] اختبارات + مزامنة GitHub
