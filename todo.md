...
- [ ] تقويم تجريبي في استوديو التقييم مرتبط بالوضعية المنجزة + كشف نقاط في دفتر التنقيط
- [ ] حياد الهوية في قوالب HTML: إزالة شعار نبراس من ترويسة A4Print (print-header-logo) والتذييل (print-footer-brand) واستبدالهما بالترويسة الرسمية الجزائرية نصياً، مع فحص بقية القوالب (المراسلات، كشوف، دفتر التنقيط، كشف فصلي، بطاقة استراتيجية)
- [ ] تحسين سياق المقطع الرسمي في موجّه توليد المذكرة (بند المقطع يظهر نصًا عامًا بدل اسم المقطع الرسمي) + أمثلة جزائرية
- [ ] إصلاح بذرة عناوين الوضعيات الخاطئة («( التعرف على الخطوات المنهجية لدراسة الآخريطة...» المكرر والإملائي)
...
- [ ] إكمال المحاكاة: إدخال نقاط 5 تلاميذ تجريبية في دفتر التنقيط (1م1/التاريخ/الفصل الثالث) والتحقق من الحفظ في gradebookEntries
- [ ] التحقق من كشف التقدم الفصلي للكفاءات (competencyModel.termReport) في صفحة الكفاءات بعد تسجيل الحصة
- [ ] التحقق البصري النهائي من المعاينة المحايدة: المكتبة (المذكرة) + استوديو التقييم + دفتر التنقيط
- [ ] بحث شامل في مواقع ومستودعات GitHub للتعليم الجزائري والتعلم النشط والبيداغوجيات الحديثة، مع تحليل استفادة نبراس منها
- [ ] تنفيذ التحسينات المستفادة من البحث (بيانات/استراتيجيات/موارد تربوية) دون إعادة هندسة
