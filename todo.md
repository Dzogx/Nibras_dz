...
- [ ] اجتياز الحلقة كاملة بمتصفح المستخدم: دخول → لوحة التحكم → Teacher OS (قسم/خطة/وضعية/منجز) → مولد الدروس → استوديو التقييم → الطباعة A4 → المكتبة → النسخة الصوتية → خطة العرض الصفي
- [ ] توثيق كل نقطة احتكاك (UX) كمستخدم حقيقي بلا معرفة برمجية
- [ ] إصلاح نقاط الاحتكاك الحرجة القابلة للإصلاح دون تغيير منطق الحلبة
- [ ] تقرير صريح للمستخدم بالملاحظات والتحسينات
...
- [ ] تنفيذ الحلقة التربوية كاملة كمستخدم ورصد الاحتكاك
- [ ] إصلاح النقاط الحرجة + اختبارات + TypeScript + فحص بصري
- [ ] checkpoint + تقرير تسليم شامل

## جلسة نضج تربوي (17 أوت — جلسة 5 ساعات مستقلة)

- [ ] إكمال dev login ودخول لوحة التحكم (كوكي Lax مضمّنة في devlogin)
- [ ] فحص قاعدة البيانات فعليًا: الوضعيات والمخططات والموارد الموجودة
- [ ] اجتياز الحلقة التربوية كاملة كمستخدم حقيقي — بدأ: الخطة السنوية 90003 (2AM) فُحصت، المولد أُنجز عبر فولباك Manus بنجاح (~40ث)، رُصد: حقل «أهداف الدرس» يعرض عنوان الوضعية بدل الأهداف، حقل المدة فارغ في المولد، لا مؤشر تقدم نصي أثناء التوليد
