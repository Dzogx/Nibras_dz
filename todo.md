...
- [ ] Audit المسارات الوظيفية من منظور أستاذ يومي (Teacher OS، مولد الدروس، Assessment Studio، المكتبة، التحليل)
- [ ] قائمة نقاط الاحتكاك UX المرتبة بالأولوية واقتراحها على المستخدم
- [ ] تنفيذ التحسينات المختارة + اختبار TypeScript والفحوصات

## تحسينات الإنتاجية وسهولة الاستخدام (16 أغسطس — بالترتيب)
- [ ] 1. Assessment Studio: نقل اختيار القسم (classId) إلى أعلى النموذج (السطر الأول) بدل إخفائه داخل «خيارات Teacher OS المتقدمة» — القسم مفتاح الترويسة الرسمية للطباعة
...
- [ ] اختبار TypeScript كامل بعد كل بند والاختبارات النهائية 88/88 قبل التسليم
