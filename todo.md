...
- [ ] استخراج قواعد دليل التربية المدنية الرسمي (جزءان: 12 نقطة + 8 نقاط، ساعة واحدة، المعامل 1)
- [ ] تحديث قاعدة التربية المدنية في محرك القواعد الوطني وفق البنية الرسمية
- [ ] تمرير شروط الدليل الخاصة (تغطية المنهاج، عدم التعجيز، سندات وظيفية، شبكة التقويم للجزء الثاني) في سياق توليد تقويم المدنية
- [ ] إضافة اختبارات سلامة للقاعدة المحدثة
- [ ] تشغيل الاختبارات ومزامنة GitHub
