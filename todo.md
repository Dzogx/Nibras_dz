...
- [ ] مطابقة صيغة الترويسة الرسمية لنموذج الأستاذ: (الولاية/المتوسطة/المستوى في السطر الأول، اسم الاختبار والمادة/التاريخ/المدة في السطر الثاني) بدل صيغة «الجمهورية/وزارة»
- [ ] حقلا «الولاية» و«اسم المتوسطة» في ملف الأستاذ واستخدامهما في ترويسة الوثائق
- [ ] دعم جداول Markdown في محتوى الوثائق المطبوعة (تحويل | col | إلى جدول HTML فعلي)
- [ ] عرض عناوين الأجزاء مظللة/مخطوطة (الجزء الأول: 12 ن) وسطر النقاط تحت عنوان كل وضعية
- [ ] اختبار العينات الجديدة (مذكرة + تقويم) وتسليمها للأستاذ
