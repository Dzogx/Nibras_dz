...
- [ ] إصلاح خلل استيراد الوضعيات المنجزة في استوديو التقييم: profile.academicYear لا يُضبط عند تفعيل الموسم فيكون seasonClasses فارغًا ويبطل الاستيراد التلقائي
- [ ] تصحيح الاحتياطي "2025-2026" في Dashboard.tsx ليشتق من الموسم الفعال بدل قيمة ثابتة
- [ ] اختبار انحدار: تفعيل الموسم يضبط academicYear في ملف الأستاذ
- [ ] اختبار انحدار: seasonClasses لا يفترض ملفًا شخصيًا محدثًا
