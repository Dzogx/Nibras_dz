...
- [ ] جدول studentGrades: القسم + المادة + الفصل + لكل تلميذ (matricule، الاسم، تاريخ الميلاد، نشاطات/20، فرض/20، اختبار/20، معدل فصلي محسوب، تقدير لفظي)
- [ ] إجراء parseRakmnaExcel (db): تحليل وثيقة حجز النقاط الرسمية واستخراج الفوج/المادة/الفصل/التلاميذ مع حراسة أخطاء عربية
- [ ] إجراء studentResults.parseExcel + saveStudentGrades (routers): معاينة قبل الحفظ ومطابقة الأفواج بأقسام نبراس
- [ ] استيراد الملف في صفحة النتائج: رفع xlsx، معاينة الحوار، تنزيل نموذج، حفظ
- [ ] لوحة نتائج التلاميذ: جدول نقاط مع بحث وترتيب وحذف ومعدل فصلي وتقدير لفظي
- [ ] تحليل الفوج: المتوسط العام، أعلى/أدنى، توزع التقديرات، ضعفاء <10 مع علاج تربوي مقترح
- [ ] تصدير PDF رسمي حيادي (جدول نقاط الفوج) للمؤسسة/المسؤول
- [ ] اختبار db.parseRakmnaExcel وانحدار شامل: vitest وTypeScript نظيف
