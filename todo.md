...
- [ ] محاكاة مسار الأستاذ من صفحة اليوم إلى الحصة والمذكرة والتقويم والتصدير وتسجيل نقاط الاحتكاك الواقعية
- [ ] تبسيط الخطوات وإصلاح الأخطاء المؤثرة التي تظهر في المسار
- [ ] التحقق البصري والتقني وحفظ تقرير نهائي بالتحسينات

## إصلاح تسجيل الدخول المنشور (20 أوت)
- [ ] تشخيص سبب تعذر تسجيل الدخول من النسخة المنشورة عبر تدفق OAuth وسجلات التشغيل
- [ ] تطبيق إصلاح موثوق والتحقق من بدء جلسة الأستاذ بنجاح
