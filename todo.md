...
- [ ] مراجعة الفروقات بين النسخة الحالية والمستودع الرسمي Dzogx/Nibras_dz وسد أي فجوات وظيفية
...
- [ ] التحقق النهائي: TypeScript + 88/88 اختبارات + checkpoint + مزامنة GitHub + تسليم + توصية النشر
